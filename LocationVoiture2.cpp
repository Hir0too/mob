...
fscanf(p,"%i %s %s %s %i %i %i %i",&t[i-1].ID,t[i-1].Marque,t[i-1].Type_Carburant,t[i-1].Modele,
&t[i-1].Nbre_Places,&t[i-1].Transmission_Auto,&t[i-1].Prix_Location,&t[i-1].Disponibilite);
